...
public class UserDataAccessObject implements SignupUserAccessInterface, UserListDataAccessInterface, ProfileDataAccessInterface {
    ...
    private ArrayList<String> turnCoursesIntoList(String coursesString) {
        ...
        return new ArrayList<>(Arrays.asList(coursesString.split("\\+")));
    }
    private User trunUserIntoUser(String line) {
